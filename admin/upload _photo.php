...
move_uploaded_file($_FILES['img']["tmp_name"],"image/".$imgfile);
move_uploaded_file($_FILES['img1']["tmp_name"],"image/big_image/".$imgfile1);
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="name" required="" placeholder="Name Of Photo">
                              </div>
                          </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Description</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="desc" required="" placeholder="About Photo">
                              </div>
                          </div>
                          
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Upload photo(size 600 x 600)</label>
                              <div class="col-sm-10">
                                  <input type="file" class="form-control" name="img" required="">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Big photo</label>
                              <div class="col-sm-10">
