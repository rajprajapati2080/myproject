...
<html lang="en">
  <?php include('include/header.php')?>
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url('images/babycover.jpg');" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 text-center" data-aos="fade-up">
            <h1>Baby Photography</h1>
            <p class="caption">36 Pictures / Baby</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row no-gutters" id="lightgallery">
        ...
        include'dbconnection.php';
         $ret=mysqli_query($con,"select * from upload_photo WHERE ptype='baby'");
