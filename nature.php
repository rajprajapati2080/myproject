...
<html lang="en">
  <?php include('include/header.php')?>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7 text-center" data-aos="fade-up">
            ...
            <h5>“Photography takes an instant out of time, altering life by holding it still.”</h5>
            <p><b>&#9866;Sunil Kumar Sahu</b></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
       <center><h5>36 Pictures / Nature</h5></center>
      <div class="row no-gutters" id="lightgallery">
         <?php
        include'dbconnection.php';
         $ret=mysqli_query($con,"select * from upload_photo WHERE ptype='nature'");
