...
<html lang="en">
  <?php include('include/header.php')?>
    <div class="site-blocks-cover overlay inner-page-cover" style="background-image: url('images/productcover.jpg');" data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <div class="container">
      ...
      <div class="row no-gutters" id="lightgallery">
        ...
        include'dbconnection.php';
         $ret=mysqli_query($con,"select * from upload_photo WHERE ptype='product'");
